module.exports = function(grunt){
	grunt.initConfig({
        ...
        htmlmin: {
        	dist: {
        		...
        		files: {
                    ...
                    "<%= BASE_FOLDER%>/<%= DIST_ENVIRONMENT%>/home.html" : "<%= BASE_FOLDER%>/home.html"
        		}
        	}
        },
        ...
        uglify: {
        	...
        	dist: {
        		files: {
        			"<%= BASE_FOLDER %>/<%= DIST_ENVIRONMENT %>/js/landingpage.js" : [
                        "<%= BASE_FOLDER %>/js/landingpage.js"
                    ],
        ...
        watch: {
	        	options: {
                    debounceDelay: 1000,
	        		livereload: 1337 // to set up a different port, so that we can keep two separate instances of sever running.
	        	},
	        	html: {
